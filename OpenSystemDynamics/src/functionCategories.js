 ...
 * @property {string} replacement - A replacement for the function.
 * @property {string} description - A description of the function.
 * @property {Object} [example] - An optional example for the function.
 * @property {string} example.definition - The definition of the example.
 * @property {string} [example.result] - An optional result for the example.
 * 
 */

/**
 * @typedef {Object} FunctionCategory
 * @property {string} name - The name of the category.
 * @property {Array<FunctionDetails>} functions - List of functions related to the category.
 */
