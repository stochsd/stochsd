                   ...
                   <fieldset class="bigheight">
                        ...
                        <table>
                            ...
                            <tr>
                                <td colspan="3">
									<span class="nowrap">
										<input checked="checked" id="optim_chk_minimise" name="max_or_min" type="radio">Minimize</input>
										<input id="optim_chk_maximise" name="max_or_min" type="radio">Maximize</input>
                                    </span>
                                </td>
                            </tr>
                        </table>
...
<p class="flexbox">
    <span>
    <button tabindex="7" id="optim_cmd_optimise">Optimize</button>
