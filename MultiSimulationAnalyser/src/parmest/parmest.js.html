...
<div class="hidden" id="parmest_help">
    After optimization or parameter estimation (using e.g. Optim),<br/>
    ...
    optimization or parameter estimation. <br/>
    <br/>
   ...
   <br/>
    ...
    in StochSD according to a certain layout. An example of<br/>
     such a Model File is shown <b><a href="#" data-help-text-id="help_model" class="cmd_help">here</a></b>.<br/>
    <br/>
        To use ParmVar you have to:  <br/>
           1. Select the file of the StochSD Model. <br/>
...
difference: &Delta;t&middot;(X_s-X)&sup2; for each time-step. V is to be minimized with<br/>
