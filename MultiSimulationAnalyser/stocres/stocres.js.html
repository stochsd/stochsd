			...
			<td>
				...
				<fieldset>
					...
					<table class="invisible">
						<tr>
							<td><input type="checkbox" name="sorted" id="do_sort">Sort by (<img src="img/cross.png"/>)</td>
							<td><button id="stocres_cmd_export_data_csv">Data (.CSV)</button></td>
						</tr>
						<!-- There is no functions to do this yet. 
							However the idea is to export the table with name, avg, Std.dev, ... etc.
							<tr>
							<td></td>
							<td><button id="stocres_cmd_export_stats_csv">Statistics (.csv)</button></td>
						</tr>-->
					</table>
				</fieldset>
			</td>
				...
				<fieldset hidden>
					...
					<p class="nowrap">
					<button id="stocres_cmd_import_data_csv">Import (.CSV)</button>
					<input type="file" id="stocres_cmd_input_csv" hidden accept=".csv" />
					<button id="stocres_cmd_clear_import" hidden>Clear Imported Data</button>
					<span id="stocres_txt_csv_filename"></span>
					</p>
				</fieldset>
